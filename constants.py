...
ENERGY_SPENDER_FONT_SIZE = 16
ENERGY_SPENDER_FONT_COLOR = FONT_COLORS["white"]
ENERGY_SPENDER_ELEMENT_SIZE = (55, 30)
ENERGY_SPENDER_DARKER = 120
ENERGY_SPENDER_BAR_SIZE = (100, ENERGY_SPENDER_ELEMENT_SIZE[1])
ENERGY_SPENDER_BAR_COLORS = [(210, 16, 27),
                          (11, 2, 170),
                          (210, 210, 10)]
ENERGY_SPENDER_SIZE = ( (ENERGY_SPENDER_ELEMENT_SIZE[0] + ENERGY_SPENDER_BAR_SIZE[0] + (ENERGY_SPENDER_PADDING * 3) + (ENERGY_SPENDER_BORDER_SIZE * 2)),
